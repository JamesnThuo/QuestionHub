...
class User(db_conn):
    ...
    def create_new_user(self):
        query=""" INSERT INTO users (firstname, lastname, email, password, registerdate) VALUES ('{}','{}','{}','{}','{}')
        """ .format(self.firstname,self.lastname,self.email,self.password,self.registerdate)
